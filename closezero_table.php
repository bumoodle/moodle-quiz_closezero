 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class quiz_report_closezero_table extends quiz_attempt_report_table 
{

    protected $regradedqs = array();

    public function __construct($quiz, $context, $qmsubselect, $qmfilter, $attemptsmode, $groupstudents, $students, $detailedmarks, $questions, $includecheckboxes, $reporturl, $displayoptions) 
    {
        parent::__construct('mod-quiz-report-closezero-report', $quiz , $context, $qmsubselect, $qmfilter, $attemptsmode, $groupstudents, $students, $questions, $includecheckboxes, $reporturl, $displayoptions);
